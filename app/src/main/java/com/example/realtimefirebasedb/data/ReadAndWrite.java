...
public class ReadAndWrite {
    ...
    public void inset(String code, String name, String desc, String uri) {
        RTModel user = new RTModel(name, desc, uri);

        mDatabase.child("Test1").child(code).setValue(user);
    }
    ...
    /*public void writeNewUserWithTaskListeners(String userId, String name, String email) {
        ...
        mDatabase.child("Test1").child(userId).setValue(user)
